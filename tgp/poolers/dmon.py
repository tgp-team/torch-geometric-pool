...
class DMoNPooling(DenseSRCPooling):
    r"""The DMoN pooling operator from the paper `"Graph Clustering
    with Graph Neural Networks" <https://arxiv.org/abs/2006.16904>`_
    (Tsitsulin et al., JMLR 2023).
    ...
    Args:
        ...
        dropout (float, optional):
            ...
            (default: :obj:`0.0`)
        spectral_loss_coeff (float, optional):
            Coefficient for the spectral loss (default: :obj:`1.0`)
        cluster_loss_coeff (float, optional):
            Coefficient for the cluster loss (default: :obj:`1.0`)
    ...
    def __init__(
        ...
        self.spectral_loss_coeff = spectral_loss_coeff
        self.ortho_loss_coeff = ortho_loss_coeff
        self.cluster_loss_coeff = cluster_loss_coeff
    ...
    def compute_loss(
        ...
        Returns:
            ...
            the auxiliary loss.
        """
        loss_1 = spectral_loss(adj, S, adj_pooled, mask, batch_reduction="mean")
